...
public class About extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        switch (DeSmuME.getCPUType()) {
            case DeSmuME.CPUTYPE_V7:
                library = "ARMv7-A legacy edition";
                break;
            case DeSmuME.CPUTYPE_NEON:
                library = "ARMv7-A + NEON edition";
                break;
            case DeSmuME.CPUTYPE_X86:
                library = "x86 edition";
                break;
            case DeSmuME.CPUTYPE_X64:
                library = "x64 edition";
                break;
            case DeSmuME.CPUTYPE_ARM64:
                library = "ARMv8-A edition";
                break;
            default:
                library = "unknown";
        }
