...
#ifndef OGLESRENDER_H
#define OGLESRENDER_H
...
EXTERNOGLEXT(PFNGLVERTEXATTRIBPOINTERPROC, glESVertexAttribPointer)
...
EXTERNOGLEXT(PFNGLFRAMEBUFFERTEXTUREEXTPROC, glFramebufferTextureEXT)
EXTERNOGLEXT(PFNGLDELETEFRAMEBUFFERSPROC, glESDeleteFramebuffers)
//EXTERNOGLEXT(PFNGLBLITFRAMEBUFFERNVPROC, glBlitFramebufferNV)

#else // OGLES3RENDER_H

// Basic functions
EXTERNOGLEXT(PFNGLGETSTRINGIPROC, glESGetStringi)

// Textures
EXTERNOGLEXT(PFNGLACTIVETEXTUREPROC, glESActiveTextures)
...
// VAO
EXTERNOGLEXT(PFNGLGENVERTEXARRAYSOESPROC, glESGenVertexArrays)
EXTERNOGLEXT(PFNGLDELETEVERTEXARRAYSOESPROC, glESDeleteVertexArrays)
EXTERNOGLEXT(PFNGLBINDVERTEXARRAYOESPROC, glESBindVertexArray)
...
EXTERNOGLEXT(PFNGLCHECKFRAMEBUFFERSTATUSPROC, glESCheckFramebufferStatus)
EXTERNOGLEXT(PFNGLFRAMEBUFFERTEXTUREEXTPROC, glFramebufferTextureEXT)
EXTERNOGLEXT(PFNGLDELETEFRAMEBUFFERSPROC, glESDeleteFramebuffer)
EXTERNOGLEXT(PFNGLBLITFRAMEBUFFERPROC, glESBlitFramebuffer)
