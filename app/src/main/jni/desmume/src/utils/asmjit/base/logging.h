...
public:
  ...
  ASMJIT_ENUM(Options) {
    ...
    kOptionNodePosition    = 0x00000020, //!< Show a node position (if any) of CodeBuilder/CodeCompiler instructions.
    kOptionDebugPasses     = 0x00000010  //!< Show an additional output from CodeBuilder/CodeCompiler passes.
  };
